...
/*----------------------------------------------------
  ...
  ----------------------------------------------------*/
  $social = array (
    'facebook'  => array('url'  => 'https://id-id.facebook.com/people/Stikom-Poltek-Cirebon/100011500628884',
      'text' => 'Facebook'
      ),
    'twitter'  => array('url'  => 'https://twitter.com/stikompoltek',
      'text' => 'Twitter'
      ),
    'youtube'  => array('url'  => 'https://www.youtube.com/watch?v=HMxl26OjaWA',
      'text' => 'Youtube'
      ),
    'gihub'  => array('url'  => 'http://datata.stikompoltek.ac.id/',
      'text' => 'Data Tugas Akhir'
      ),
    'forum'  => array('url'  => 'http://eklib.stikompoltek.ac.id',
      'text' => 'Link Eksternal'
      )
    );
?>
...
<html>
<head>
<title><?php echo 'STIKOM PolTek Digital Library'; ?></title>
...
<meta name="keywords" content="stikom, stikom poltek, stikom poltek cirebon, perpustakaan stikom, perpustakaan stikom poltek, perpustakaan stikom poltek cirebon">
    ...
    <div class="navbar-inner">
      <div class="container">
        ...
        <a class="brand" href="index.php">
         <div class="sitename"><?php echo 'STIKOM PolTek Digital Library'; ?></div>
         <div class="subname"><?php echo 'Perpustakaan Elektronik STIKOM PolTek Cirebon'; ?></div>
        </a>
 ...
 <div class="container">
  <div class="row">
    <div class="span12 lisence">
     STIKOM PolTek Cirebon | Jl. Brigjend Darsono No.33 by pass Cirebon (0231) 486475
   </div>
 </div>
</div>
</div>
...
jQuery(function($){
  $.supersized(
  {
    ...
    {image : '<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/img/kodomo1.jpg'}
    ]
  });
});
